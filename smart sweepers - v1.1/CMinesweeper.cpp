...
bool CMinesweeper::Update(vector<SVector2D> &mines,vector<SVector2D> &people)
{
	...
	//calculate dot product of the look at vector and Closest person
	//vector. This will give us the angle we need turn to face
	//the closest people
...
//----------------------GetClosestObject()---------------------------------
//
//	returns the vector from the sweeper to the closest person
//
//-----------------------------------------------------------------------
SVector2D CMinesweeper::GetClosestPeople(vector<SVector2D> &people)
{
	...
	//cycle through people to find closest
...
//----------------------------- CheckForPeople -----------------------------
//
//  this function checks for collision with its closest people (calculated
//  earlier and stored in m_iClosestPeople)
//-----------------------------------------------------------------------
