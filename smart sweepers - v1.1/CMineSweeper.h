...
private:
	...
	//index position of closest people
...
public:
	...
	//returns a vector to the closest people
	...
	//checks to see if the minesweeper has 'hited' a person
	...
	void			        DecrementFitness(){m_dFitness=m_dFitness-4;}
